    ...
    <div v-if="isOpen" class="fixed inset-0 z-50 md:hidden">
      ...
      <aside class="relative ml-auto flex h-full w-[84vw] max-w-80 flex-col overflow-y-auto border-l border-white/10 bg-slate-950 p-5">
        ...
        <div class="mt-auto flex flex-col gap-2 pt-6">
          <a href="https://github.com/ryankutella25" target="_blank" rel="noreferrer" aria-label="GitHub" class="inline-flex items-center rounded-md p-2 text-slate-300 transition hover:bg-white/10">
          ...
          <a href="https://www.linkedin.com/in/ryankutella/" target="_blank" rel="noreferrer" aria-label="LinkedIn" class="inline-flex items-center rounded-md p-2 text-slate-300 transition hover:bg-white/10">
            <svg class="h-6 w-6" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
          ...
          <a href="mailto:ryankutella25@yahoo.com" class="rounded-md px-3 py-2 text-sm text-slate-300 transition hover:bg-white/10">Email</a>
          <a
            href="/RyanKutella.pdf"
            target="_blank"
            rel="noreferrer"
            class="mt-2 inline-flex w-max items-center rounded-md border border-cyan-300/80 bg-cyan-300/10 px-3 py-1.5 text-sm font-semibold text-cyan-200"
          >Resume</a>
        </div>
      </aside>
    </div>
