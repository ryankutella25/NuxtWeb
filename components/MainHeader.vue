...
<template>
  <div class="header">
        ...
        <div class="rightHeader">
          <UButton :padded="false" variant="ghost" style="margin-left: 20px;"  to="https://www.linkedin.com/in/ryankutella/" target="_blank"><Icon name="uil:linkedin" color="#ddd" to="https://www.linkedin.com/in/ryankutella/" size="24px"/></UButton>
